...
import { logoutJWTUser } from "app/redux/auth/authSlice";
import UserSessionCard from "app/views/ui-kits/cards/UserSessionCard";

export default function Layout1Header() {
  const dispatch = useDispatch();
  const { handleMenuClick, toggleFullScreen } = useHeader();
          ...
          <Dropdown>
            ...
            <Dropdown.Menu className="mt-3">
              <Dropdown.Item className="text-center">
                <div className="fw-bold">Welcome: {user?.username}</div>
              </Dropdown.Item>

              <Dropdown.Divider />

              <Dropdown.Item onClick={() => setShowProfile(true)}>
                <i className="i-Data-Settings me-1" /> Profile
              </Dropdown.Item>
