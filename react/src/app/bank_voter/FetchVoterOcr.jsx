...
//       fetchWallet();
//       swal.fire("Success", "Voter OCR extracted", "success");
//     } catch (err) {
...
//                 <tr><th>Message</th><td>{safe(result.data?.message)}</td></tr>
//                 <tr><th>Voter ID</th><td>{safe(normalizedOcr.id_number)}</td></tr>
//                 <tr><th>Name</th><td>{safe(normalizedOcr.name)}</td></tr>
//                 <tr><th>DOB</th><td>{safe(normalizedOcr.date_of_birth)}</td></tr>
//                 <tr><th>Issue Date</th><td>{safe(normalizedOcr.issue_date)}</td></tr>
//                 <tr><th>Gender</th><td>{safe(normalizedOcr.gender)}</td></tr>
//                 <tr><th>State</th><td>{safe(normalizedOcr.state)}</td></tr>
//                 <tr><th>Address</th><td>{safe(normalizedOcr.address)}</td></tr>
