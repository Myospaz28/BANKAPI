...
//     icon:"i-Checked-User",
//     sub: [
//       { icon: "i-Add-User", name: "Add Users", path: "/users/add", type: "link" },
//       // { icon: "i-Add-UserStar", name: "Add Admin", path: "/users/add-admin", type: "link" },
//       { icon: "i-Business-Mens", name: "User List", path: "/users/user-list", type: "link" },
//     ]
//   },
...
//     // path: "/uikits/cards",
//      sub: [
//        { icon: "i-Add", name: "Add Service", path: "/users/user-list", type: "link" },
//       { icon: "i-Gear-2", name: "Services", path: "/uikits/cards", type: "link" },
//     ]
...
export const navigations = [
  {
    ...
    icon: "i-Bar-Chart",
    path: "/dashboard/v2",
    roles: ["admin", "bank"], // 👈 visible to all
  },
