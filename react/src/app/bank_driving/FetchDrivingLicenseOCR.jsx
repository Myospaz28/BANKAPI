...

        {
          table: {
            ...
            body: [
              ...
              ["Issued Date", safe(d.issued_date)],
              ["Valid Till", safe(d.valid_till)],
              ["Guardian", safe(d.dependent_name)],
              ["Place of Issue", safe(d.place_of_issue)],
      ...
      <Col md={12}>
        ...
        <Card body className="mb-4">
          ...
          <Button
            ...
            disabled={loading}
          >
            {loading ? <Spinner size="sm" /> : "Run DL OCR"}
          </Button>
        </Card>
