...
//     if (!rcNumber || !ownerName) {
//       swal.fire("Validation Error", "All required fields must be filled", "warning");
//       return;
//     }

//     if (wallet < credits) {
//       swal.fire("Insufficient Credits", "You do not have enough credits", "error");
//       return;
//     }

//     const confirm = await swal.fire({
//       title: "Confirm RC Fetch",
//       html: `
...
//     pdfMake.createPdf(doc).download(`RC_${rcNumber}.pdf`);
//   };
...
//           <Button className="mt-3" variant="success" disabled={loading} onClick={handleFetch}>
